<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="EntitySplittingDemoCodeFirst.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div style="font-family: Arial">
            ...
            <br />
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="EntitySplittingDemoCodeFirst.Employee" DeleteMethod="DeleteEmployee" InsertMethod="InsertEmployee" SelectMethod="GetEmployee" TypeName="EntitySplittingDemoCodeFirst.EmployeeRepository" UpdateMethod="UpdateEmployee"></asp:ObjectDataSource>
        </div>
    </form>
</body>
</html>
